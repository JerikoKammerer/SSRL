...
class Pins():
    def __init__(self):
        ...
        self.FF1_X = digitalio.DigitalInOut(board.D21) #GPIO 21
        self.FF1_X.direction = digitalio.Direction.INPUT
        
        self.FF2_X = digitalio.DigitalInOut(board.D20)    #GPI0 20
        self.FF2_X.direction = digitalio.Direction.INPUT
        
        self.FF1_Y = digitalio.DigitalInOut(board.D25)    #GPIO 25
        self.FF1_Y.direction = digitalio.Direction.INPUT
        
        self.FF2_Y = digitalio.DigitalInOut(board.D24)    #GPIO 24
        self.FF2_Y.direction = digitalio.Direction.INPUT
        
        self.FF1_Z = digitalio.DigitalInOut(board.D27)    #GPIO27
        ...
        self.DIR_X = digitalio.DigitalInOut(board.D19)    #GPIO 19
        self.DIR_X.direction = digitalio.Direction.OUTPUT
        
        self.DIR_Y = digitalio.DigitalInOut(board.D23)    #GPIO 23
        self.DIR_Y.direction = digitalio.Direction.OUTPUT
        
        self.DIR_Z = digitalio.DigitalInOut(board.D17)    #GPIO 17
        ...
        self.resetX = digitalio.DigitalInOut(board.D16)    #GPIO 16
        self.resetX.direction = digitalio.Direction.OUTPUT
        self.resetX.value = True

        self.resetY = digitalio.DigitalInOut(board.D22)   #GPIO 22
        self.resetY.direction = digitalio.Direction.OUTPUT
        self.resetY.value = True

        self.resetZ = digitalio.DigitalInOut(board.D4)   #GPIO 4
